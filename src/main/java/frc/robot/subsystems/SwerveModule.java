...
public class SwerveModule {
    ...
    // swerve module
    private final PIDController m_turningPIDController = new PIDController(ModuleConstants.kTurnP,
            ModuleConstants.kTurnI, ModuleConstants.kTurnD);
    ...
    public SwerveModule(int driveMotorChannel, int turningMotorChannel, int turningEncoderChannel, double angularOffset,
        ...
        m_driveMotor.setSmartCurrentLimit(CurrentLimit.kDriveTranslation); // Set current limit for the drive motor
        ...
        // Set velocity conversion factor so that encoder and PID control is in terms of velocity in m/s
        ...
        // driveMotorChannel
        m_turningMotor.setSmartCurrentLimit(CurrentLimit.kDriveRotation); // Set current limit for the drive motor
